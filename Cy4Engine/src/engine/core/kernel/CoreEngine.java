...
public class CoreEngine {
	...
	public void createWindow(int width, int height) {
		createWindow(width, height, "Cy4Engine", "./res/logo/oreon_lwjgl_icon32.png");
	}

	public void createWindow(int width, int height, String name) {
		createWindow(width, height, name, "./res/logo/oreon_lwjgl_icon32.png");
	}

	public void createWindow(int width, int height, String name, String imagePath) {
		glfwInit();
	...
	public void init() {
		engine.core.configs.Default.init();
